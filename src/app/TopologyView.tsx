  ...
  return (
    <div className="flex items-center">
      ...
      <div className="relative group flex items-center">
        ...
        {depth > 0 && (
          <div className="w-10 h-[2px] bg-slate-300 dark:bg-slate-700 flex-shrink-0" />
        )}
        ...
        `}>
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className={`font-bold text-xs truncate ${isGroup ? "text-slate-700 dark:text-slate-200" : "text-slate-200 dark:text-slate-300"}`}>
              {item.name}
            </span>
          </div>
          ...
          <div className="flex justify-between items-end">
            ...
            <div className="text-right">
              ...
              <span className={`font-mono text-sm font-black ${isGroup ? "text-blue-600 dark:text-blue-400" : "text-blue-400 dark:text-blue-500"}`}>
